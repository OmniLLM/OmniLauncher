...
struct PluginRuntimeDependency {
    id: &'static str,
    label: &'static str,
    installed: bool,
    installable: bool,
...
#[tauri::command]
fn list_plugin_runtime_dependencies() -> Vec<PluginRuntimeDependency> {
    let python_installed = python_installer::bundled_python_exe().is_some()
...
async fn install_plugin_runtime_dependency(
    ...
    match id.as_str() {
        "python" => {
            ...
            let exe = python_installer::install_bundled_python_with_progress(|message| {
...
fn runtime_install_plan(id: &str) -> Result<(String, Vec<String>, String), String> {
    #[cfg(windows)]
    {
...
fn runtime_manual_command(id: &str) -> Option<String> {
    #[cfg(windows)]
    {
        return match id {
