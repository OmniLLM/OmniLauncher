...
static EMOJIS: &[(&str, &str, &[&str])] = &[
    ...
    ("😂", "face with tears of joy", &["laugh", "lol", "funny", "cry", "haha"]),
    ("🥹", "holding back tears", &["grateful", "moved", "touched", "cry"]),
    ("😭", "loudly crying face", &["sad", "cry", "sob", "tears"]),
    ("😍", "heart eyes", &["love", "crush", "adore", "beautiful"]),
    ("🥰", "smiling face with hearts", &["love", "affection", "cute", "adore"]),
    ("😘", "kissing face with heart", &["kiss", "love", "mwah", "blowing"]),
    ("🤣", "rolling on floor laughing", &["rofl", "laugh", "funny", "lol"]),
    ("😊", "smiling face with eyes", &["happy", "blush", "smile", "pleased"]),
    ("🙃", "upside down face", &["sarcasm", "silly", "irony", "joking"]),
    ("😏", "smirking face", &["smug", "sly", "flirt", "smirk"]),
    ("😒", "unamused face", &["annoyed", "meh", "bored", "unimpressed"]),
    ("😔", "pensive face", &["sad", "thoughtful", "regret", "sorry"]),
    ("😢", "crying face", &["sad", "tear", "cry", "unhappy"]),
    ("😤", "face with steam", &["frustrated", "angry", "annoyed", "huffing"]),
    ("😡", "pouting face", &["angry", "mad", "rage", "red"]),
    ("🤬", "face with symbols on mouth", &["swear", "angry", "cursing", "mad"]),
    ("🤯", "exploding head", &["mind blown", "shocked", "wow", "surprised"]),
    ("😱", "screaming in fear", &["scared", "shocked", "oh no", "horror"]),
    ("😨", "fearful face", &["scared", "fear", "nervous", "anxiety"]),
    ("😰", "anxious face with sweat", &["worried", "nervous", "stress", "sweat"]),
    ("😓", "downcast face with sweat", &["tired", "hard work", "sweat", "relief"]),
    ("🤗", "hugging face", &["hug", "warm", "embrace", "friendly"]),
    ("🤔", "thinking face", &["think", "ponder", "hmm", "question"]),
    ("🤐", "zipper mouth face", &["quiet", "secret", "silence", "shh"]),
    ("😴", "sleeping face", &["sleep", "tired", "zzz", "nap"]),
    ("🤒", "face with thermometer", &["sick", "ill", "fever", "unwell"]),
    ("🤢", "nauseated face", &["sick", "disgusted", "gross", "nausea"]),
    ("🤮", "vomiting face", &["sick", "gross", "disgusting", "barf"]),
    ("🥵", "hot face", &["hot", "overheated", "sweating", "fever"]),
    ("🥶", "cold face", &["cold", "freezing", "chilly", "frost"]),
    ("😇", "smiling face with halo", &["angel", "innocent", "good", "pure"]),
    ("🥳", "partying face", &["party", "celebrate", "birthday", "fun"]),
    ("🤩", "star-struck", &["wow", "amazing", "star", "excited", "star eyes"]),
    ("😎", "smiling face with sunglasses", &["cool", "chill", "awesome", "sunglasses"]),
    ("🧐", "face with monocle", &["curious", "inspect", "detective", "hmm"]),
    ("🤓", "nerd face", &["nerd", "geek", "smart", "glasses"]),
    ("👍", "thumbs up", &["like", "good", "yes", "approve", "ok"]),
    ("👎", "thumbs down", &["dislike", "bad", "no", "disapprove"]),
    ("👏", "clapping hands", &["applause", "clap", "bravo", "celebrate"]),
    ("🙌", "raising hands", &["celebrate", "praise", "hooray", "yay"]),
    ("🤝", "handshake", &["deal", "agree", "partnership", "shake"]),
    ("🙏", "folded hands", &["please", "pray", "thank you", "namaste"]),
    ("👊", "oncoming fist", &["fist", "punch", "bump", "fight"]),
    ("✊", "raised fist", &["fist", "power", "solidarity", "strong"]),
    ("🤞", "crossed fingers", &["luck", "hope", "wish", "fingers"]),
    ("✌️", "victory hand", &["peace", "victory", "two", "v sign"]),
    ("🤟", "love you gesture", &["love", "rock", "ily", "hand"]),
    ("🤙", "call me hand", &["call", "hang loose", "phone", "shaka"]),
    ("👆", "backhand pointing up", &["up", "point", "above", "direction"]),
    ("👇", "backhand pointing down", &["down", "point", "below", "direction"]),
    ("👈", "backhand pointing left", &["left", "point", "direction"]),
    ("👉", "backhand pointing right", &["right", "point", "direction"]),
    ("☝️", "index pointing up", &["one", "point", "up", "attention"]),
    ("🫵", "index pointing at viewer", &["you", "point", "choose", "pick"]),
    ("💪", "flexed biceps", &["strong", "muscle", "flex", "workout"]),
    ("🦾", "mechanical arm", &["robot", "strong", "bionic", "prosthetic"]),
    ("🖐️", "hand with fingers splayed", &["five", "stop", "hi", "hand"]),
    ("✋", "raised hand", &["stop", "high five", "wait", "raise"]),
    ("👋", "waving hand", &["hello", "hi", "wave", "bye", "goodbye"]),
    ("🤚", "raised back of hand", &["stop", "hand", "raise", "back"]),
    ("🖖", "vulcan salute", &["star trek", "spock", "vulcan", "live long"]),
    ("💅", "nail polish", &["nails", "fancy", "done", "sassy"]),
    ("🫶", "heart hands", &["love", "heart", "hands", "care"]),
    ("❤️", "red heart", &["love", "heart", "romance", "affection"]),
    ...
    ("💜", "purple heart", &["love", "heart", "purple", "royalty"]),
    ("🖤", "black heart", &["love", "heart", "black", "dark"]),
    ("🤍", "white heart", &["love", "heart", "white", "pure"]),
    ("💔", "broken heart", &["heartbreak", "sad", "loss", "rejection"]),
    ("❤️‍🔥", "heart on fire", &["love", "passion", "burning", "intense"]),
    ("💯", "hundred points", &["perfect", "100", "agree", "score"]),
    ("💥", "collision", &["boom", "explosion", "pow", "bang"]),
    ("✨", "sparkles", &["sparkle", "shine", "glitter", "magic", "star"]),
    ...
    ("🎉", "party popper", &["party", "celebrate", "congrats", "tada"]),
    ("🎊", "confetti ball", &["party", "celebrate", "confetti", "festival"]),
    ("🎈", "balloon", &["balloon", "birthday", "party", "celebration"]),
    ("🎁", "wrapped gift", &["gift", "present", "birthday", "wrap"]),
    ("🏆", "trophy", &["award", "win", "champion", "trophy", "first"]),
    ("🥇", "first place medal", &["gold", "win", "first", "champion"]),
    ("🎯", "bullseye", &["target", "hit", "accurate", "goal", "dart"]),
    ("🚀", "rocket", &["launch", "space", "fast", "rocket", "ship"]),
    ("💡", "light bulb", &["idea", "light", "bulb", "bright", "innovation"]),
    ("🔑", "key", &["key", "access", "password", "unlock", "lock"]),
    ("🔒", "locked", &["lock", "secure", "password", "private"]),
    ("🔓", "unlocked", &["unlock", "open", "access", "free"]),
    ("⚡", "lightning", &["lightning", "fast", "power", "electric", "zap"]),
    ("🌈", "rainbow", &["rainbow", "colorful", "hope", "gay", "pride"]),
    ("☀️", "sun", &["sun", "sunny", "warm", "day", "bright"]),
    ("🌙", "crescent moon", &["moon", "night", "sleep", "crescent"]),
    ("⭕", "hollow red circle", &["circle", "zero", "correct", "o"]),
    ("❌", "cross mark", &["wrong", "no", "cancel", "x", "error"]),
    ("✅", "check mark button", &["done", "yes", "correct", "check", "ok"]),
    ("❓", "question mark", &["question", "ask", "help", "what"]),
    ("❗", "exclamation mark", &["important", "alert", "warning", "attention"]),
    ...
    ("💻", "laptop", &["computer", "laptop", "work", "code", "tech"]),
    ...
    ("🖱️", "computer mouse", &["mouse", "cursor", "click", "pointer"]),
    ...
    ("🎮", "video game", &["game", "gaming", "controller", "play", "xbox"]),
    ("🕹️", "joystick", &["game", "joystick", "arcade", "control"]),
    ("📚", "books", &["books", "read", "study", "learn", "library"]),
    ...
    ("📨", "incoming envelope", &["email", "mail", "inbox", "receive"]),
    ("📤", "outbox tray", &["send", "upload", "outbox", "email"]),
    ("📥", "inbox tray", &["receive", "download", "inbox", "email"]),
    ("📦", "package", &["package", "box", "delivery", "parcel"]),
    ("🗑️", "wastebasket", &["trash", "delete", "bin", "waste"]),
    ("🔍", "magnifying glass", &["search", "find", "zoom", "investigate"]),
    ("🔧", "wrench", &["tool", "wrench", "fix", "repair", "settings"]),
    ("⚙️", "gear", &["settings", "gear", "config", "options"]),
    ("🔨", "hammer", &["hammer", "build", "tool", "construct"]),
    ("🪛", "screwdriver", &["screwdriver", "tool", "fix", "repair"]),
    ("🧲", "magnet", &["magnet", "attract", "pull", "metal"]),
    ("💰", "money bag", &["money", "cash", "rich", "wealth", "bag"]),
    ("💳", "credit card", &["card", "payment", "credit", "buy"]),
    ("💎", "gem stone", &["diamond", "gem", "jewel", "precious", "luxury"]),
    ("🏠", "house", &["home", "house", "building", "live"]),
    ("🏢", "office building", &["office", "work", "building", "company"]),
    ("🌍", "earth", &["world", "earth", "globe", "international"]),
    ("🗺️", "world map", &["map", "world", "travel", "navigate"]),
    ("✈️", "airplane", &["plane", "fly", "travel", "airplane", "flight"]),
...
impl Plugin for EmojiPickerPlugin {
    ...
    async fn query(&self, q: &Query) -> Vec<QueryResult> {
        let search = q.raw.strip_prefix("emoji ").unwrap_or("").trim().to_lowercase();
