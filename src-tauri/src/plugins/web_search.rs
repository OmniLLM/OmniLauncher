...
const SEARCH_ENGINES: &[(&str, &str, &str, &str, &str)] = &[
    ...
    ("g ",        "Google",        "🔍",  "https://www.google.com/search?q={}",                    "google.com"),
    ("yt ",       "YouTube",       "▶️",  "https://www.youtube.com/results?search_query={}",       "youtube.com"),
    ("gh ",       "GitHub",        "🐙",  "https://github.com/search?q={}",                        "github.com"),
    // Flow.Launcher-compatible keywords
    ("youtube ",  "YouTube",       "▶️",  "https://www.youtube.com/results?search_query={}",       "youtube.com"),
    ("netflix ",  "Netflix",       "🎬",  "https://www.netflix.com/search?q={}",                   "netflix.com"),
    ("translate ","Google Translate","🌐","https://translate.google.com/#auto|en|{}",               "translate.google.com"),
    ("gmail ",    "Gmail",         "📧",  "https://mail.google.com/mail/ca/u/0/#apps/{}",           "mail.google.com"),
    ("drive ",    "Google Drive",  "📁",  "https://drive.google.com/?hl=en&tab=bo#search/{}",      "drive.google.com"),
    ("ytmusic ",  "YouTube Music", "🎵",  "https://music.youtube.com/search?q={}",                 "music.youtube.com"),
    ("wiki ",     "Wikipedia",     "📖",  "https://en.wikipedia.org/wiki/{}",                      "wikipedia.org"),
    ("facebook ", "Facebook",      "👥",  "https://www.facebook.com/search/?q={}",                 "facebook.com"),
    ("twitter ",  "Twitter / X",   "🐦",  "https://twitter.com/search?q={}",                      "twitter.com"),
    ("maps ",     "Google Maps",   "🗺️", "https://maps.google.com/maps?q={}",                     "maps.google.com"),
    ("duckduckgo ","DuckDuckGo",   "🦆",  "https://duckduckgo.com/?q={}",                          "duckduckgo.com"),
    ("ddg ",      "DuckDuckGo",    "🦆",  "https://duckduckgo.com/?q={}",                          "duckduckgo.com"),
    ("github ",   "GitHub",        "🐙",  "https://github.com/search?q={}",                        "github.com"),
    ("gist ",     "GitHub Gist",   "📝",  "https://gist.github.com/search?q={}",                   "gist.github.com"),
    ("wolframalpha ","WolframAlpha","🧮", "https://www.wolframalpha.com/input/?i={}",              "wolframalpha.com"),
    ("so ",       "Stack Overflow","💬",  "https://stackoverflow.com/search?q={}",                 "stackoverflow.com"),
    ("stackoverflow ","Stack Overflow","💬","https://stackoverflow.com/search?q={}",               "stackoverflow.com"),
    ("lucky ",    "I'm Feeling Lucky","🍀","https://www.google.com/search?q={}&btnI=I",            "google.com"),
    ("image ",    "Google Images", "🖼️", "https://www.google.com/search?q={}&tbm=isch",           "images.google.com"),
    ("bing ",     "Bing",          "🔵",  "https://www.bing.com/search?q={}",                      "bing.com"),
    ("yahoo ",    "Yahoo",         "💜",  "https://search.yahoo.com/search?p={}",                  "search.yahoo.com"),
];
