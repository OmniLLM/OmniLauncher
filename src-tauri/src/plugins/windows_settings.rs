...
impl Plugin for WindowsSettingsPlugin {
    ...
    async fn query(&self, q: &Query) -> Vec<QueryResult> {
        ...
        #[cfg(target_os = "macos")]
        let settings: Vec<(&str, &str, &str)> = vec![
            ("Display",          "x-apple.systempreferences:com.apple.Displays-Settings.extension",                "Display settings"),
            ("Sound",            "x-apple.systempreferences:com.apple.Sound-Settings.extension",                   "Sound settings"),
            ("Notifications",    "x-apple.systempreferences:com.apple.Notifications-Settings.extension",           "Notification settings"),
            ("Battery",          "x-apple.systempreferences:com.apple.Battery-Settings.extension",                 "Battery settings"),
            ("Bluetooth",        "x-apple.systempreferences:com.apple.BluetoothSettings",                         "Bluetooth & devices"),
            ("WiFi",             "x-apple.systempreferences:com.apple.wifi-settings-extension",                    "WiFi settings"),
            ("VPN",              "x-apple.systempreferences:com.apple.Network-Settings.extension",                 "VPN / Network settings"),
            ("Wallpaper",        "x-apple.systempreferences:com.apple.Wallpaper-Settings.extension",              "Wallpaper settings"),
            ("Appearance",       "x-apple.systempreferences:com.apple.Appearance-Settings.extension",             "Appearance & accent colors"),
            ("Lock Screen",      "x-apple.systempreferences:com.apple.Lock-Screen-Settings.extension",            "Lock screen settings"),
            ("Screen Saver",     "x-apple.systempreferences:com.apple.ScreenSaver-Settings.extension",            "Screen saver settings"),
            ("Dock",             "x-apple.systempreferences:com.apple.Dock-Settings.extension",                   "Dock & menu bar"),
            ("Mission Control",  "x-apple.systempreferences:com.apple.MissionControl-Settings.extension",         "Mission Control"),
            ("Mouse",            "x-apple.systempreferences:com.apple.Mouse-Settings.extension",                  "Mouse settings"),
            ("Trackpad",         "x-apple.systempreferences:com.apple.Trackpad-Settings.extension",               "Trackpad settings"),
            ("Keyboard",         "x-apple.systempreferences:com.apple.Keyboard-Settings.extension",               "Keyboard settings"),
            ("Software Update",  "x-apple.systempreferences:com.apple.Software-Update-Settings.extension",        "Software Update"),
            ("Privacy",          "x-apple.systempreferences:com.apple.settings.PrivacySecurity.extension",        "Privacy & Security"),
            ("Time & Language",  "x-apple.systempreferences:com.apple.Localization-Settings.extension",           "Language & Region"),
            ("Accounts",         "x-apple.systempreferences:com.apple.Internet-Accounts-Settings.extension",      "Internet Accounts"),
            ("Users & Groups",   "x-apple.systempreferences:com.apple.Users-Groups-Settings.extension",           "Users & Groups"),
            ("Accessibility",    "x-apple.systempreferences:com.apple.Accessibility-Settings.extension",          "Accessibility"),
            ("Focus",            "x-apple.systempreferences:com.apple.Focus-Settings.extension",                  "Focus / Do Not Disturb"),
            ("Energy Saver",     "x-apple.systempreferences:com.apple.Energy-Settings.extension",                 "Energy Saver"),
            ("Sharing",          "x-apple.systempreferences:com.apple.Sharing-Settings.extension",                "Sharing"),
            ("Startup Disk",     "x-apple.systempreferences:com.apple.Startup-Disk-Settings.extension",           "Startup Disk"),
            ("About",            "x-apple.systempreferences:com.apple.SystemInformation.pane",                    "About This Mac"),
        ];
        ...
        let settings: Vec<(&str, &str, &str)> = vec![
            ("Display",          "gnome-control-center display",            "Display settings"),
            ("Sound",            "gnome-control-center sound",              "Sound settings"),
            ("Notifications",    "gnome-control-center notifications",      "Notification settings"),
            ...
            ("Network",          "gnome-control-center network",            "Network settings"),
            ("Background",       "gnome-control-center background",         "Background / Wallpaper"),
            ("Appearance",       "gnome-control-center appearance",         "Appearance"),
            ("Lock Screen",      "gnome-control-center lock-screen",        "Lock screen"),
            ("Mouse",            "gnome-control-center mouse",              "Mouse & Touchpad"),
            ("Keyboard",         "gnome-control-center keyboard",           "Keyboard shortcuts"),
            ("Apps",             "gnome-control-center applications",       "Default applications"),
            ("Privacy",          "gnome-control-center privacy",            "Privacy"),
            ("Date & Time",      "gnome-control-center datetime",           "Date & Time"),
            ("Region",           "gnome-control-center region",             "Region & Language"),
            ("Users",            "gnome-control-center user-accounts",      "User Accounts"),
            ("Accessibility",    "gnome-control-center universal-access",   "Accessibility"),
            ("Online Accounts",  "gnome-control-center online-accounts",    "Online Accounts"),
            ("Printers",         "gnome-control-center printers",           "Printers"),
            ("Removable Media",  "gnome-control-center removable-media",    "Removable Media"),
            ("Software",         "gnome-software",                          "Software Center"),
            ("Updates",          "gnome-software --mode=updates",           "Software Updates"),
            ("About",            "gnome-control-center info-overview",      "About This Computer"),
        ];
    ...
    async fn execute_tool(&self, args: serde_json::Value) -> String {
        ...
        let settings: Vec<(&str, &str)> = vec![
            ...
            ("dock",          "x-apple.systempreferences:com.apple.Dock-Settings.extension"),
            ...
            ("time",          "x-apple.systempreferences:com.apple.Localization-Settings.extension"),
            ...
            ("about",         "x-apple.systempreferences:com.apple.SystemInformation.pane"),
        ];
        #[cfg(not(any(target_os = "windows", target_os = "macos")))]
        let settings: Vec<(&str, &str)> = vec![
